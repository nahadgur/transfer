    ...
    <div className="min-h-screen bg-[#050505] py-8 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-space font-bold text-white mb-2">Pension Transfer Calculator</h1>
          <p className="text-zinc-400">Calculate costs to transfer pension between schemes in Kenya</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6">
              ...
              {/* Current Scheme */}
              <div className="mb-6">
                <label className="block text-sm text-zinc-400 mb-3">Current Pension Scheme</label>
              ...
              {/* Target Scheme */}
              <div className="mb-6">
                <label className="block text-sm text-zinc-400 mb-3">Transfer To</label>
                <div className="grid grid-cols-2 gap-2">
                  {PENSION_SCHEMES.map((scheme) => (
                    <button
                      key={scheme.id}
              ...
              {/* Transfer Amount */}
              <div className="mb-6">
                <label className="block text-sm text-zinc-400 mb-3">Amount to Transfer (KES)</label>
                <input
                  type="number"
                  value={transferAmount}
                  onChange={(e) => setTransferAmount(Math.max(0, Number(e.target.value)))}
                  className="w-full bg-white/10 border border-white/20  px-4 py-3 text-white text-xl font-semibold focus:outline-none focus:border-pink-500"
                />
                <input
                  type="range"
                  min="50000"
              ...
              {/* Years to Retirement */}
              <div>
                <label className="block text-sm text-zinc-400 mb-3">Years to Retirement: {yearsToRetirement}</label>
                <input
                  type="range"
                  min="1"
                  max="40"
          ...
          {/* Results Section */}
          <div className="space-y-6">
            <div className="backdrop-blur-xl  border border-pink-500/20 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center py-3 border-b border-white/10">
                  <span className="text-zinc-400">Transfer Fee ({targetSchemeData.name})</span>
                ...
                <div className="flex justify-between items-center py-3 border-b border-white/10">
                  <span className="text-zinc-400">RBA Certificate Fee</span>
            ...
            {/* Projected Growth */}
            <div className="backdrop-blur-xl  border border-[#ccff00]/20 p-6">
              ...
              <div className="flex justify-between items-center py-4 bg-white/5  px-4">
                <span className="text-zinc-300">Projected Value at Retirement</span>
                <span className="text-2xl font-bold text-[#ccff00]">{formatCurrency(projectedValue)}</span>
              </div>
